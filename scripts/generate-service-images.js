 ...
 * for Eagle Waste Solutions service pages
 */
...
const services = [
  {
    ...
    prompt: "Professional waste removal team collecting household garbage, furniture, and appliances from a clean suburban home driveway in Los Angeles, California. Professional service workers loading items onto a clean waste removal truck. Modern residential neighborhood, bright daylight, professional photography style, high quality, 4K, realistic, detailed."
  },
  {
    id: "commercial-waste-removal-hero",
    name: "Commercial Waste Removal Hero",
    prompt: "Commercial waste removal truck and professional crew servicing a business complex in Los Angeles, California. Large commercial dumpsters, professional workers in uniforms, modern commercial building in background, efficient service operation, professional photography style, high quality, 4K, realistic, detailed."
  },
  {
    id: "junk-removal-hero",
    name: "Junk Removal Hero",
    prompt: "Professional junk removal team loading old furniture, appliances, mattresses, and household items onto a clean, professional junk removal truck. Residential property setting, organized removal process, professional workers in action,Los Angeles California, bright daylight, professional photography style, high quality, 4K, realistic, detailed."
  },
  {
    id: "dumpster-rental-hero",
    name: "Dumpster Rental Hero",
    prompt: "Large professional dumpster rental container placed on a residential driveway in Los Angeles, California. Clean dumpster with company branding, professional placement, modern residential home in background, construction or renovation materials visible nearby, professional photography style, high quality, 4K, realistic, detailed."
  },
];
