...
const FurniturePickupHauling: React.FC = () => {
  const benefits = [
    {
      icon: <Sofa className="w-8 h-8 text-blue-900" />,
      title: 'All Furniture Types',
      description: 'We remove sofas, beds, tables, chairs, dressers, desks, and any other furniture items you need gone.'
    },
    {
      icon: <Zap className="w-8 h-8 text-blue-900" />,
      title: 'Same-Day Service',
      description: 'Need furniture removed quickly? We offer same-day pickup for most items when you call early.'
    },
    {
      icon: <Shield className="w-8 h-8 text-blue-900" />,
      title: 'Careful Handling',
      description: 'Our team carefully removes furniture without damaging your walls, floors, or doorways.'
    },
    {
      icon: <Recycle className="w-8 h-8 text-blue-900" />,
      title: 'Donate & Recycle',
      description: 'Usable furniture is donated to local charities. We recycle materials whenever possible.'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-blue-900 font-bold tracking-wider text-sm uppercase">FURNITURE PICKUP & HAULING</span>
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mt-4 mb-6">
                Furniture Pickup & Hauling Services
              </h1>
              <div className="w-20 h-1 bg-yellow-500 mb-6"></div>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Getting rid of old furniture doesn't have to be a hassle. Our professional furniture pickup service 
                removes unwanted pieces from your home quickly and responsibly, so you can enjoy your space again.
              </p>
            ...
            <div className="relative">
              <div className="overflow-hidden h-[500px] md:h-[600px] rounded-2xl">
                <img 
                  src="/eaglewaste/furniture.jpg" 
                  alt="Professional Furniture Pickup Service" 
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Our Furniture Removal Service?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Professional furniture removal saves you time, effort, and the risk of injury from heavy lifting.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <div className="bg-gray-50 rounded-2xl p-8 md:p-10">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Our furniture pickup process is simple and stress-free. We do all the heavy lifting for you.
            </p>
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">We carefully remove your furniture</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Donate, recycle, or dispose responsibly</span>
              </li>
            </ul>
          </div>
          <div className="bg-gray-50 rounded-2xl p-8 md:p-10">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Whether you're moving, redecorating, or clearing out an estate, we have the right solution.
            </p>
            <ul className="space-y-3">
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Single item pickup</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
              ...
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Estate and foreclosure cleanouts</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Commercial furniture removal</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-12 md:p-16 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Contact us today for a free estimate. We'll haul away your unwanted furniture quickly and responsibly.
          </p>
...
export default FurniturePickupHauling;
