  ...
  const benefits = [
    {
      ...
      description: 'Our team understands construction sites and knows how to safely remove debris without disrupting your project.'
    },
    {
      icon: <Zap className="w-8 h-8 text-blue-900" />,
      title: 'Fast Turnaround',
      description: 'We work on your schedule to keep your project moving. Same-day and next-day service available.'
    },
    {
      icon: <Shield className="w-8 h-8 text-blue-900" />,
      title: 'Licensed & Insured',
      description: 'Fully licensed and insured for construction site work. We follow all safety protocols and regulations.'
    },
    {
      icon: <Recycle className="w-8 h-8 text-blue-900" />,
      title: 'Responsible Disposal',
      description: 'We sort and recycle construction materials whenever possible, reducing landfill waste.'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-blue-900 font-bold tracking-wider text-sm uppercase">CONSTRUCTION DEBRIS REMOVAL</span>
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mt-4 mb-6">
                Construction Debris Removal Services
              </h1>
              <div className="w-20 h-1 bg-yellow-500 mb-6"></div>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Keep your construction site clean and safe with our professional debris removal service. We handle 
                everything from small renovation projects to large construction site cleanups.
              </p>
            ...
            <div className="relative">
              <div className="overflow-hidden h-[500px] md:h-[600px] rounded-2xl">
                <img 
                  src="/eaglewaste/348s-2.jpg" 
                  alt="Professional Construction Debris Removal" 
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Our Construction Debris Service?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Professional debris removal keeps your site safe, compliant, and productive.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <div className="bg-gray-50 rounded-2xl p-8 md:p-10">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              We make construction debris removal simple so you can focus on your project.
            </p>
            <ul className="space-y-3">
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Call for a free site assessment</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Schedule removal around your project</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">We load and haul all debris</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Site left clean and ready to work</span>
              </li>
            </ul>
          </div>
          <div className="bg-gray-50 rounded-2xl p-8 md:p-10">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              We offer flexible solutions for projects of all sizes.
            </p>
            <ul className="space-y-3">
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">One-time debris removal</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Scheduled recurring pickups</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Large volume removal</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Emergency same-day service</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-12 md:p-16 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Contact us today for a free estimate. Keep your construction site clean and safe.
          </p>
