...
export const initializeChat = async (): Promise<Chat> => {
  ...
  chatSession = ai.chats.create({
    ...
    config: {
      ...
      We are a professional waste removal company serving Los Angeles County and Orange County.
      ...
      If asked about location, mention we serve Los Angeles County and Orange County.`,
    },
  });
